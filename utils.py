...
def vis_grid_4x3(model) -> None:
    ...
    """
    images = []
    pair_directories = ['/scratch/mulay.am/datasets/yamaha_v0/train/iid001080', '/scratch/mulay.am/datasets/yamaha_v0/train/iid001229',
                        '/scratch/mulay.am/datasets/yamaha_v0/train/iid000713', '/scratch/mulay.am/datasets/yamaha_v0/train/iid001092']
    # pair_directories = ['/scratch/mulay.am/datasets/yamaha_v0/train/iid000183',
    #                     '/scratch/mulay.am/datasets/yamaha_v0/train/iid000657',
    #                     '/scratch/mulay.am/datasets/yamaha_v0/train/iid000499',
    #                     '/scratch/mulay.am/datasets/yamaha_v0/train/iid001092']
    brown = [139, 69, 19]
    dark_green = [0, 100, 0]
